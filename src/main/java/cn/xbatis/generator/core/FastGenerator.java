...
package cn.xbatis.generator.core;


import cn.xbatis.generator.core.config.GeneratorConfig;
import cn.xbatis.generator.core.database.meta.EntityInfo;
import cn.xbatis.generator.core.database.meta.TableInfo;
import cn.xbatis.generator.core.database.meta.TableMetaDataQuery;
import cn.xbatis.generator.core.template.ITemplateBuilder;
import cn.xbatis.generator.core.template.engine.FreemarkerTemplateEngine;
import cn.xbatis.generator.core.template.engine.TemplateEngine;
import cn.xbatis.generator.core.util.RuntimeUtils;
...
public class FastGenerator {
    ...
    public void create() {
        ...
        try (Connection connection = generatorConfig.getDataBaseConfig().getConnection()) {
            ...
            log.info("xbatis-generator found {} tables and {} views",
        ...
        log.info("xbatis-generator's base file path is {}", generatorConfig.getBaseFilePath());
